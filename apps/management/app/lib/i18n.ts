...
const he = {
  ...
  restaurants_assigned: "שליחים משויכים",
  restaurants_capacity: "כיסוי בפועל",
  restaurants_alert: "חוסר בכיסוי מול סטטוס VIP",
  vip_half: "0.5 שליח (משותף)",
...
const en: Messages = {
  ...
  restaurants_assigned: "Assigned couriers",
  restaurants_capacity: "Actual coverage",
  restaurants_alert: "Coverage below VIP status",
  vip_half: "0.5 courier (shared)",
